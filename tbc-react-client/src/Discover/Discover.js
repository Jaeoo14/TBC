          ...
          <div className="row">
            ...
            <div className="dropdown">
              <Button
                ...
                href="/page.html"
              >
                <span style={{ fontSize: "0.9rem", marginTop: "0.2rem" }}>
                  카테고리
                </span>
              </Button>
              <ul
              ...
              >
                ...
                <li className="dropdown-submenu">
                  ...
                  <ul className="dropdown-menu">
                    <li
                      className="dropdown-item"
                      onClick={() => this.viewCategoryBy(10)}
                    >
                      음악 전체
                    </li>
                ...
                <li className="dropdown-submenu">
                  ...
                  <ul className="dropdown-menu">
                    <li
                      className="dropdown-item"
                      onClick={() => this.viewCategoryBy(11)}
                    >
                      출판 전체
                    </li>
                ...
                <li className="dropdown-submenu">
                  ...
                  <ul className="dropdown-menu">
                    <li
                      className="dropdown-item"
                      onClick={() => this.viewCategoryBy(12)}
                    >
                      테크 전체
                    </li>
                ...
                <li className="dropdown-submenu">
                  ...
                  <ul className="dropdown-menu">
                    <li
                      className="dropdown-item"
                      onClick={() => this.viewCategoryBy(13)}
                    >
                      패션 전체
                    </li>
                ...
                <li className="dropdown-submenu">
                  ...
                  <ul className="dropdown-menu">
                    <li
                      className="dropdown-item"
                      onClick={() => this.viewCategoryBy(14)}
                    >
                      저널리즘 전체
                    </li>
            ...
            <div className="btn-group show-on-hover">
              ...
              <ul className="dropdown-menu" role="menu">
                ...
                <li
                  className="dropdown-item"
                  onClick={this.viewGoalUnder75to100}
                >
                  75%~100%
                </li>
            ...
            <div className="btn-group show-on-hover">
              ...
              <ul className="dropdown-menu" role="menu">
                ...
                <li
                  className="dropdown-item"
                  onClick={this.viewAmount100to10000}
                >
                  1백만원~1천만원
                </li>
                <li
                  className="dropdown-item"
                  onClick={this.viewAmount1000to5000}
                >
                  1천만원~5천만원
                </li>
                <li
                  className="dropdown-item"
                  onClick={this.viewAmount5000toMillion}
                >
                  5천만원~1억원
                </li>
                <li
                  className="dropdown-item"
                  onClick={this.viewAmountOverMillion}
                >
                  1억원 이상
                </li>
              </ul>
        ...
        <div className="wrapper">
            ...
            <div className="col-md-12">
              ...
              <div className="filter">
                ...
                <ul className="dropdown-menu" role="menu">
                  ...
                  <li
                    className="dropdown-item"
                    onClick={this.viewAlignAmountPercent}
                  >
                    최다 후원순
                  </li>
                  <li
                    className="dropdown-item"
                    onClick={this.viewAlignFundAmount}
                  >
                    최다 금액순
                  </li>
          ...
          <div className="row">
            {this.state.lists.map((list) => (
              <div
                onClick={() =>
                  this.props.history.push({ pathname: "/detail", state: list })
                }
              >
                <Item
                  key={list.id}
