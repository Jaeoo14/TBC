  ...
  render() {
    return (
      <div className="full">
        ...
        <div className="title">{`${this.props.longTitle}`}</div>
          ...
          <div class="flex">
            <div style={{ float: "center", paddingLeft: "5" }}>
              ...
              >
                ...
                {`    ${this.numberDemical(
                  (this.props.fundedAmount * 100) / this.props.fundingGoalAmount
                )}`}
                %&nbsp;
              </Box>
              ...
              <Box
                ...
                paddingLeft={5}
              >
                <Moment fromNow>{this.props.fundingEnd}</Moment>
              ...
              <Box
                ...
                paddingLeft={5}
              >
                목표 금액인 {`${this.state.goal}`}원이 모여야만 결제됩니다.
              </Box>
              <Box
                fontSize={12}
                color="black"
                ...
                paddingLeft={5}
              >
                결제는 {`${this.props.fundingEnd}`}에 다함께 진행됩니다.
              </Box>
              <PushBtn />
            </div>
          </div>
